...
export default function Home() {
  return (
    <>
      <NextSeo title="Vihar Kurama | Home" description="" />
      <SiteLayout>
        <div className="my-5 pt-5">
          ...
          <p className="text-muted">
            ...
            Intelligence consulting firm. We build Intelligent Products and Scalable Web
            Applications for clients in Ed-tech, Finance, and Healthcare sectors.
          </p>
          ...
          <Link href="/writings">
            <a className="text-decoration-none">
              <p className="text-muted mb-0 mt-3 fw-light p-small">
                View all writings<i className="bi bi-arrow-right ms-2"></i>
              </p>
            </a>
          </Link>
